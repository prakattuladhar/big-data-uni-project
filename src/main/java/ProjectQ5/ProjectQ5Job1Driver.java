...
public class ProjectQ5Job1Driver {
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(ProjectQ5Job1Driver.class);
